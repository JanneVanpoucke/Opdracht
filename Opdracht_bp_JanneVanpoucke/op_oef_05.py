...
print("Resultaat:")
print("mijn reeks =",afdruk[:-1])#er wordt pas geprint nadat de for loop opnieuw gelopen heeft tot eindGetal, daarom staat print op zelfde niveau van for loop, maar niet in de for loop